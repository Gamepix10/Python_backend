...
users = [
    User(id=1, username='andreq2', first_name='Andrew',
         last_name='Johns', age=23, created_at=datetime.now()),
    User(id=2, username='matr3', first_name='Marti',
         last_name='Fletcher', age=32, created_at=datetime.now()),
    User(id=3, username='bm32', first_name='Billy',
         last_name='Murdack', age=83, created_at=datetime.now()),
]
